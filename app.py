...
print(f"🚀 Starting Portfolio Intelligence Backend for Railway")
...
def health_check():
    ...
    result = {
        ...
        'server': 'Railway Portfolio Intelligence'
    }
...
def root():
    """Root endpoint"""
    return jsonify({
        'message': 'Portfolio Intelligence API - Railway Deployment',
        'status': 'running',
        'data_source': 'Yahoo Finance (yfinance)',
        'environment': 'production',
        'endpoints': [
...
if __name__ == '__main__':
    ...
    print(f"🚀 Starting Flask server on Railway...")
